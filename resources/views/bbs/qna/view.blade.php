    ...
    <section id="inquiry-view" class="board-wrap">
        ...
        <div class="view-wrap">
            ...
            <div class="btn-wrap right-list">
                <a class="btn_list btn01" href="/qna/">목록</a>
                <form action="/qna/del" method="post" style="display: inline-block" onsubmit="if(!confirm('삭제하시겠습니까?')) { return false; }">
                    @csrf
{{--                                        @method("delete")--}}
                    <button class="btn_delete btn01">삭제</button>
                    <input type="hidden" name="id" value="{{ $lists->id}}">
                </form>
                <a class="btn_modify btn01" href="/qna/modify/{{$lists->id}}">수정</a>
                <a class="btn_write btn01" href="/qna/add">글쓰기</a>
            </div>
        </div>{{-- //.view-wrap end --}}
    </section>
@endsection
