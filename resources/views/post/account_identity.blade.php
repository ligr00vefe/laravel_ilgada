    ...
    <article id="company-document" class="" style="overflow-x: auto;">
            ...
            <table class="company-list in-input table-2x-large">
                ...
                @foreach ($lists as $i => $list)
                    <tr>
                        ...
                        <td>
                            <span><a href="/post/account_identity?id={{ $list->co_code }}">{{ $list->co_name }}</a></span>
                        </td>
                        <td>
        ...
        <div class="content-right">
            <ul class="document-tab">
                ...
                <li class="active"><a href="/post/account_identity">신분증</a></li>
            ...
            <div class="document-tab_contents">
                ...
                {{-- 세번째 탭 --}}
                <div class="-03">
                    <div class="card-wrap id-card-info">
                        <ul>
                            ...
                            @foreach ($view_data as $i => $view_datas)
                                <li>
                                    {{--<div>--}}
                                        {{--<input type="checkbox" name="check[]" id="check_{{$i}}" value="" class="card_checked">--}}
                                        {{--<label for="check_{{$i}}"></label>--}}
                                    {{--</div>--}}
                                    <div class="img-wrap">
                                        <div class="card-front">
                                            <img src="{{asset('/storage/'.$view_datas->photo1)}}" id="changePhoto">
                                        </div>
                                        <div class="card-back">
                                            <img src="{{asset('/storage/'.$view_datas->photo2)}}" id="changePhoto">
                                        </div>
                                    </div>
                                    <div class="text-wrap">
...
<script>
    ...
    /*신분증 사이즈 조절*/
    $(document).ready(function(){
        var idCard = $('.document-tab_contents .card-wrap ul li .img-wrap div');
        var cardWidth = idCard.width();
        var cardHeight = cardWidth * 0.625;

        // console.log('신분증 width: ', cardWidth);
        // console.log('신분증 height: ', cardHeight);
        idCard.height(cardHeight);
    });
</script>
@endsection
