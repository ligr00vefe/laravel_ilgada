...
@section("content")
    ...
    <div id="member_register">
        ...
        <form action="/admin/member/register" method="post" name="register_form" enctype="multipart/form-data" >
            @csrf
            <div class="table-wrap table02">
                ...
                <tr>
                    <th>대표자명</th>
                    <td><input type="text" name="name" class="tbl-input w300" required></td>
                    <th>상호명</th>
                    <td><input type="text" name="co_name" class="tbl-input w300" required></td>
                </tr>

                <tr>
                    <th>업태</th>
                    <td><input type="text" name="business_type" class="tbl-input w300" required></td>
                    <th>업종</th>
                    <td><input type="text" name="business_item" class="tbl-input w300" required></td>
                </tr>
                ...
                <tr>
                    <th>연락처</th>
                    <td>
                        <input type="text" name="tel1" class="tbl-input w80" required>
                        <span class="hyphen">-</span>
                        <input type="text" name="tel2" class="tbl-input w80" required>
                        <span class="hyphen">-</span>
                        <input type="text" name="tel3" class="tbl-input w80" required>
                    </td>
                    <th>휴대전화</th>

                    <td>
                        <input type="text" name="phone1" class="tbl-input w80" required>
                        <span class="hyphen">-</span>
                        <input type="text" name="phone2" class="tbl-input w80" required>
                        <span class="hyphen">-</span>
                        <input type="text" name="phone3" class="tbl-input w80" required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <input type="text" name="address" class="tbl-input w500" id="sample6_address" placeholder="주소" required><br>
                        <input type="text" name="address_detail" class="tbl-input w500" id="sample6_detailAddress" placeholder="상세주소" required>
                    </td>
                </tr>
