...
@section("content")
    <div id="member_register">
        ...
        <form action="/admin/payments/period" method="post" name="register_form" enctype="multipart/form-data">
            <input type="hidden" name="co_code" value="8" class="tbl-input w300" required>
            @csrf
